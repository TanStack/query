...
export const ExamplesWithInvalidateQueriesMethodCall = () => {
  ...
  queryClient.invalidateQueries({ queryKey: 'todos', exact: true }, options)
  queryClient.invalidateQueries({ queryKey: ['todos'] })
  queryClient.invalidateQueries({ queryKey: ['todos'], exact: true })
  queryClient.invalidateQueries({ queryKey: ['todos'], exact: true }, options)
  // Direct hook call.
  useQueryClient().invalidateQueries({ queryKey: 'todos' })
...
export const ExamplesWithRefetchQueriesMethodCall = () => {
  ...
  queryClient.refetchQueries({ queryKey: 'todos', exact: true }, options)
  queryClient.refetchQueries({ queryKey: ['todos'] })
  queryClient.refetchQueries({ queryKey: ['todos'], exact: true })
  queryClient.refetchQueries({ queryKey: ['todos'], exact: true }, options)
  // Direct hook call.
  useQueryClient().refetchQueries({ queryKey: 'todos' })
  useQueryClient().refetchQueries({ queryKey: 'todos', exact: true })
  useQueryClient().refetchQueries({ queryKey: 'todos', exact: true }, options)
  useQueryClient().refetchQueries({ queryKey: ['todos'] })
  useQueryClient().refetchQueries({ queryKey: ['todos'], exact: true })
  useQueryClient().refetchQueries({ queryKey: ['todos'], exact: true }, options)
...
export const ExamplesWithRemoveQueriesMethodCall = () => {
  ...
  queryClient.removeQueries({ queryKey: ['todos'], exact: true })
  // Direct hook call.
  useQueryClient().removeQueries({ queryKey: 'todos' })
  useQueryClient().removeQueries({ queryKey: 'todos', exact: true })
  useQueryClient().removeQueries({ queryKey: ['todos'] })
  useQueryClient().removeQueries({ queryKey: ['todos'], exact: true })
...
export const ExamplesWithResetQueriesMethodCall = () => {
  ...
  queryClient.resetQueries({ queryKey: 'todos', exact: true }, options)
  queryClient.resetQueries({ queryKey: ['todos'] })
  queryClient.resetQueries({ queryKey: ['todos'], exact: true })
  queryClient.resetQueries({ queryKey: ['todos'], exact: true }, options)
  // Direct hook call.
  useQueryClient().resetQueries({ queryKey: 'todos' })
  useQueryClient().resetQueries({ queryKey: 'todos', exact: true })
  useQueryClient().resetQueries({ queryKey: 'todos', exact: true }, options)
  useQueryClient().resetQueries({ queryKey: ['todos'] })
  useQueryClient().resetQueries({ queryKey: ['todos'], exact: true })
  useQueryClient().resetQueries({ queryKey: ['todos'], exact: true }, options)
