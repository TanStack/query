...
Defined in: [packages/angular-query/src/infinite-query-options.ts:34](https://github.com/TanStack/query/blob/main/packages/angular-query/src/infinite-query-options.ts#L34)
