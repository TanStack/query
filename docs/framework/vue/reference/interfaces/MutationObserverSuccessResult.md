...
Defined in: [packages/query-core/src/types.ts:1480](https://github.com/TanStack/query/blob/main/packages/query-core/src/types.ts#L1480)
...
| <a id="data"></a> `data` | `TData` | The last successfully resolved data for the mutation. | [`MutationObserverBaseResult`](MutationObserverBaseResult.md).[`data`](MutationObserverBaseResult.md#data) |
...
| <a id="isidle"></a> `isIdle` | `false` | A boolean variable derived from `status`. - `true` if the mutation is in its initial state prior to executing. | [`MutationObserverBaseResult`](MutationObserverBaseResult.md).[`isIdle`](MutationObserverBaseResult.md#isidle) |
...
| <a id="issuccess"></a> `isSuccess` | `true` | A boolean variable derived from `status`. - `true` if the last mutation attempt was successful. | [`MutationObserverBaseResult`](MutationObserverBaseResult.md).[`isSuccess`](MutationObserverBaseResult.md#issuccess) |
