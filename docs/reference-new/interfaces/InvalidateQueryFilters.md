...
# Interface: InvalidateQueryFilters\<TQueryKey\>

Defined in: [packages/query-core/src/types.ts:582](https://github.com/TanStack/query/blob/main/packages/query-core/src/types.ts#L582)
...
Defined in: [packages/query-core/src/types.ts:584](https://github.com/TanStack/query/blob/main/packages/query-core/src/types.ts#L584)
