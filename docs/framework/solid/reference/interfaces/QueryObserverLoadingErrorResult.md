...
Defined in: [packages/query-core/src/types.ts:985](https://github.com/TanStack/query/blob/main/packages/query-core/src/types.ts#L985)
...
| <a id="isloadingerror"></a> `isLoadingError` | `true` | Will be `true` if the query failed while fetching for the first time. | [`QueryObserverBaseResult`](QueryObserverBaseResult.md).[`isLoadingError`](QueryObserverBaseResult.md#isloadingerror) |
