...
# Interface: QueryObserverPendingResult\<TData, TError\>
...
Defined in: [packages/query-core/src/types.ts:801](https://github.com/TanStack/query/blob/main/packages/query-core/src/types.ts#L801)
