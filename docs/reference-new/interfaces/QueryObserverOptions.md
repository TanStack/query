...
# Interface: QueryObserverOptions\<TQueryFnData, TError, TData, TQueryData, TQueryKey, TPageParam\>
...
```ts
optional behavior: QueryBehavior<TQueryFnData, TError, TQueryData, TQueryKey>;
```
...
```ts
optional enabled: Enabled<TQueryFnData, TError, TQueryData, TQueryKey>;
```
