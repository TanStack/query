...
# Interface: QueryObserverPlaceholderResult\<TData, TError\>

Defined in: [packages/query-core/src/types.ts:876](https://github.com/TanStack/query/blob/main/packages/query-core/src/types.ts#L876)
