...
Defined in: [packages/react-query/src/useSuspenseQueries.ts:169](https://github.com/TanStack/query/blob/main/packages/react-query/src/useSuspenseQueries.ts#L169)
