...
- A new instance of `injectQuery(() => ({ queryKey: ['todos'], queryFn: fetchTodos }))` mounts.
...
- A second instance of `injectQuery(() => ({ queryKey: ['todos'], queryFn: fetchTodos })` mounts elsewhere.
...
- Both instances of the `injectQuery(() => ({ queryKey: ['todos'], queryFn: fetchTodos })` query are unmounted and no longer in use.
...
- The final instance of `injectQuery(() => ({ queryKey: ['todos'], queryFn: fetchTodos })` unmounts.
