...
Defined in: [packages/solid-query/src/infiniteQueryOptions.ts:26](https://github.com/TanStack/query/blob/main/packages/solid-query/src/infiniteQueryOptions.ts#L26)
