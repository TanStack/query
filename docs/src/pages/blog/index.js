...
export default function BlogIndex({
  ...
  return <div className="h-full min-h-full">
      ...
      <Seo title="Blog" description="Stories, tips, and tools to inspire you to build better software." />
        ...
        <div className="relative ">
          <div>
            ...
            <div className="mt-3 sm:mt-4 lg:grid lg:grid-cols-2 lg:gap-5 lg:items-center">
              ...
              <form action="https://api.formik.com/submit/palmerhq/formik-newsletter" method="post" className="mt-6 flex lg:mt-0 lg:justify-end">
          ...
          <div className={markdownStyles['markdown']}>
            ...
            <div className="mt-6 grid gap-16 border-t border-gray-100 pt-10 lg:grid-cols-2 lg:col-gap-5 lg:row-gap-12">
              {posts.map(post => {
              return <div key={post.Slug} className="space-y-2  pb-6">
                    {post.Date && <div className="posted text-gray-500 leading-5 text-sm">
                      ...
                      <Link href="/blog/[...slug]" as={getBlogLink(post.Slug)}>
                        <a className="block">
                          <span className="hover:underline cursor-pointer">
                            {!post.Published && <span className={blogStyles.draftBadge}>
                                Draft
                              </span>}
                            {post.Page}
                          </span>{' '}
                    ...
                    <div className=" mt-3  leading-6 text-gray-500">
                      <div className={cn(markdownStyles.markdown, 'text-gray-500')}>
                        ...
                        {(post.preview || []).map((block, idx) => <p key={`preview-${post.Slug}-${idx}`}>
