...
Defined in: [packages/query-core/src/types.ts:1535](https://github.com/TanStack/query/blob/main/packages/query-core/src/types.ts#L1535)
...
| <a id="ispending"></a> `isPending` | `true` | A boolean variable derived from `status`. - `true` if the mutation is currently executing. | [`MutationObserverBaseResult`](MutationObserverBaseResult.md).[`isPending`](MutationObserverBaseResult.md#ispending) |
