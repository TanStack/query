...
For tips on organizing Query Keys in larger applications, have a look at [Effective React Query Keys](https://tanstack.com/query/v4/docs/community/tkdodos-blog#8-effective-react-query-keys) from
