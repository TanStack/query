...
Defined in: [packages/solid-query/src/infiniteQueryOptions.ts:54](https://github.com/TanStack/query/blob/main/packages/solid-query/src/infiniteQueryOptions.ts#L54)
