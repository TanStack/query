...
- [#11308](https://github.com/TanStack/query/pull/11308) [`c809e09`](https://github.com/TanStack/query/commit/c809e09e89ef00f7e9ffef9390012dfcc379222b) - feat: rewrite the adapter onto Solid 2.0's native async model. Query reads
  ...
  from [#8950](https://github.com/TanStack/query/issues/8950) — `use*` is the only naming; `isInitialLoading` (deprecated
