...
Preact Query is compatible with Preact v10+ and works with preact-render-to-string and Preact SSR.
...
> You can find instructions on how to use Preact without JSX [here](https://preactjs.com/guide/v10/getting-started#without-jsx).
