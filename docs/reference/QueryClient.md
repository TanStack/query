...
- `defaultOptions?: DefaultOptions`
  ...
  - You can also define defaults to be used for [hydration](../../docs/framework/react/reference/hydration)
...
- `queryKey: QueryKey`: [Query Keys](../../docs/framework/react/guides/query-keys)
...
- `filters: QueryFilters`: [Query Filters](../../docs/framework/react/guides/filters#query-filters)
...
TanStack Query also exports a handy [`useIsFetching`](../../docs/framework/react/reference/useIsFetching) hook that will let you subscribe to this state in your components without creating a manual subscription to the query cache.
...
TanStack Query also exports a handy [`useIsMutating`](../../docs/framework/react/reference/useIsMutating) hook that will let you subscribe to this state in your components without creating a manual subscription to the mutation cache.

**Options**

- `filters: MutationFilters`: [Mutation Filters](../../docs/framework/react/guides/filters#mutation-filters)
