...
describe("useQuery's in Suspense mode", () => {
  ...
  it('should not call the queryFn twice when used in Suspense mode', async () => {
    ...
    queryFn.mockImplementation(() => {sleep(10); return 'data'})
  ...
  it('should remove query instance when component unmounted', async () => {
    ...
    function Page() {
      useQuery(key, () => {sleep(10); return 'data'}, { suspense: true })
  ...
  it('should call every onSuccess handler within a suspense boundary', async () => {
    ...
    function FirstComponent() {
      useQuery(key, () => {sleep(10); return 'data'}, {
        suspense: true,
    ...
    function SecondComponent() {
      useQuery(key, () => {sleep(20); return 'data'}, {
        suspense: true,
