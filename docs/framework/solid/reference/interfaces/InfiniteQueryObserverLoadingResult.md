...
Defined in: [packages/query-core/src/types.ts:1074](https://github.com/TanStack/query/blob/main/packages/query-core/src/types.ts#L1074)
...
| <a id="isloading"></a> `isLoading` | `true` | Is `true` whenever the first fetch for a query is in-flight. - Is the same as `isFetching && isPending`. | [`InfiniteQueryObserverBaseResult`](InfiniteQueryObserverBaseResult.md).[`isLoading`](InfiniteQueryObserverBaseResult.md#isloading) |
...
| <a id="ispending"></a> `isPending` | `true` | Will be `pending` if there's no cached data and no query attempt was finished yet. | [`InfiniteQueryObserverBaseResult`](InfiniteQueryObserverBaseResult.md).[`isPending`](InfiniteQueryObserverBaseResult.md#ispending) |
