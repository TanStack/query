...
- [#10943](https://github.com/TanStack/query/pull/10943) [`64a8035`](https://github.com/TanStack/query/commit/64a8035303a7d979d54d9fff9220904f218246c7) - fix(lit-query): migrate to the standard tsdown build so the `build` output is cached by nx and `test:build` passes
