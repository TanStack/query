...
<!-- DON'T EDIT THIS SECTION, INSTEAD RE-RUN doctoc TO UPDATE -->
  ...
  - [Queries](#queries)
    - [Query Keys](#query-keys)
      - [String-Only Query Keys](#string-only-query-keys)
      - [Array Keys](#array-keys)
      - [Query Keys are serialized deterministically!](#query-keys-are-serialized-deterministically)
    - [Query Key Variables](#query-key-variables)
    - [Optional Variables](#optional-variables)
    - [Dependent Queries](#dependent-queries)
      - [Pass a falsey query key](#pass-a-falsey-query-key)
      - [Pass a query key array with a falsey item](#pass-a-query-key-array-with-a-falsey-item)
      - [Use a query key function](#use-a-query-key-function)
      - [Mix them together!](#mix-them-together)
    ...
    - [Load-More & Infinite-Scroll with `useInfiniteQuery`](#load-more--infinite-scroll-with-useinfinitequery)
      ...
      - [What if I need to pass custom information to my query function?](#what-if-i-need-to-pass-custom-information-to-my-query-function)
  ...
  - [Custom Query Key Serializers (Experimental)](#custom-query-key-serializers-experimental)
      - [URL Query Key Serializer Example](#url-query-key-serializer-example)
      - [Function Query Key Serializer Example](#function-query-key-serializer-example)
- [API](#api)
  - [`useQuery`](#usequery)
    - [Options](#options)
    - [Returns](#returns)
  ...
  - [`queryCache.setQueryData`](#querycachesetquerydata)
    - [Options](#options-6)
    - [Using an updater value](#using-an-updater-value)
    - [Using an updater function](#using-an-updater-function)
