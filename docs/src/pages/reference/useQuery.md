...
- `refetchOnMount: boolean | "always" | ((data: TData | undefined, query: Query) => boolean | "always")`
  - Optional
  - Defaults to `true`
...
- `refetchOnWindowFocus: boolean | "always" | ((data: TData | undefined, query: Query) => boolean | "always")`
  - Optional
  - Defaults to `true`
  ...
  - If set to a function, the function will be executed with the latest data and query to compute the value
- `refetchOnReconnect: boolean | "always" | ((data: TData | undefined, query: Query) => boolean | "always")`
  - Optional
  - Defaults to `true`
